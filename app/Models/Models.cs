...
namespace PcOptimizer
{
    ...
    public sealed class AppItem : INotifyPropertyChanged
    {
        ...
        public AppItem()
        {
            Id = ""; Name = ""; Version = ""; Publisher = ""; Source = ""; Scope = "";
            State = ""; InstallLocation = ""; UninstallCommand = ""; QuietUninstallCommand = "";
            PackageFullName = ""; ProvisionedPackageName = ""; FeatureName = ""; CapabilityName = "";
            ExecutableHint = ""; RiskReason = ""; Description = ""; Action = "Desinstalar";
        }
        ...
        public string UniqueKey { get { return Kind.ToString() + "|" + Id + "|" + Scope; } }

        public void RaiseResourceChanged()
        {
            Notify(nameof(CpuText));
            Notify(nameof(MemoryText));
            Notify(nameof(DiskText));
            Notify(nameof(ProcessText));
